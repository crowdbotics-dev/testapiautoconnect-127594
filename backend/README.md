...
## Project Structure
    ...
    ├── testapiautoconnect_127594  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_127594`
...
2. Clone this repo and `cd testapiautoconnect_127594`
